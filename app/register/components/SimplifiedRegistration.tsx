...
export default function SimplifiedRegistration({ onBack, isModal = false }: SimplifiedRegistrationProps) {
  const { language } = useLanguage()
  const router = useRouter()
  const [currentStep, setCurrentStep] = useState<'auth' | 'identity'>('auth')
